...
public class ListTabActivity extends TabActivity
{
	public void onCreate(Bundle savedInstanceState)
	{
		...
		TabSpec tabAllUndoneTask = host.newTabSpec("Pending");
		tabAllUndoneTask.setIndicator("Pending");
		...
		TabSpec tabAllMutedTask = host.newTabSpec("Done");
		tabAllMutedTask.setIndicator("Done");
		...
		TabSpec tabAllNearTask = host.newTabSpec("Muted");
		tabAllNearTask.setIndicator("Muted");
